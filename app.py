...
def processRequest(req):
    if req.get("result").get("action") == "yahooWeatherForecast":
        ...
        area = {'Toilets':'are located before security, beside Spar in Main Terminal building, or after security, at Gate 30, and Gate 3. We wanted to let you know that we are working hard to create the airport our region loves and are planning some renovations to the upper retail level, located after Security. The upgrades mean that we will have to close the toilets on the upper retail level. The nearest toilets will be on the lower retail level and there will be signage in place.','Arrivals':'in the main terminal building', 'Starbucks':'is located at the check-in area, before security, and in the Departure Lounge, after security on the Lower Level.', 'Spar':'At right hand side of terminal building', 'Lounge':'Departure lounge, after security on the lower level. The Aspire Premium Lounge at Liverpool John Lennon Airport is open to all passengers regardless of travel class.', 'Car Hire' : 'We offer car hire from Europcar, Hertz, Enterprise and Avis, all of which can be found in Liverpool John Lennon Airport’s Car Rental Centre, located on the ground floor of the short stay multi-storey car park directly opposite the terminal building, across from the Arrivals Area. Just walk across from the terminal building towards the Express Drop Off & Pick Up Car Park. Cars can be returned to the Car Rental Car Park, located off the airport approach road by taking the third exit off the roundabout.','Security':'Liverpool John Lennon Airport recommends passengers arrive a minimum of 2 hours before departure to allow sufficient time to check-in, pass through airport security and to take advantage of the many new passenger facilities now available in the departure lounge.','Subway':'can be found in the Departure Lounge, after security on the Lower Level. It can also be found on the Arrivals concourse, on the ground floor.','Kissing Gate':'can be found in the Departure Lounge, after security on the Lower Level.'}
