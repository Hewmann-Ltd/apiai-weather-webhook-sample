...
def processRequest(req):
    if req.get("result").get("action") == "yahooWeatherForecast":
        ...
        if airportName == "Liverpool John Lennon Airport":
                ...
                area = {'Toilets':'are located before checkin, beside the express lift coming into terminal building, beside the outszie baggage ares. In the departure lounge beside John Lewis or between Case and Duty Free, or at Gate Level between Mulberry and Burberry'}
